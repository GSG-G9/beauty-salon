...
describe('test getServices query and /api/v1/services route', () => {
  ...
  test(`getServices query, expected the third service to be object with name 
    ...
    return expect(rows[3]).toEqual({
      ...
      image:
            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTq-HgGmgVOadBLCPbwNi0dWb5zs0-c43oih4vHuZwtZPjDS2duIq9rR-VihB9E-hHMCBk&usqp=CAU',
    });
  });
      ...
      data:
          ...
          },
          {
            ...
            description:
               'haircut will begin with a complete consultation for a personalized cut',
            image:
               'https://d1qp59yxlq7zhd.cloudfront.net/media/01-10-2019-latest-haircut-for-girls_Long_with_Layers_3.PNG',
          },
          {
            id: 3,
            name: 'Mens HAIRCUT',
            ...
            description:
               'haircut will begin with a complete consultation for a personalized cut',
            image:
               'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJQlXN65ERh2zHfbhq4TmN5oSET5vrAnY-jq2HGzrct5sv59x0ssOKW1C3L3DgCOtLNpo&usqp=CAU',
          },
          {
            id: 4,
            name: 'Master HAIRCUT',
          ...
          {
            id: 6,
            name: 'Dazzle Dry Vegan',
            category: 'nails',
            description:
               'nail lacquer invites you to flaunt a most sophisticated holiday manicure',
            image:
               'https://3.bp.blogspot.com/-49K6_wMSbCU/XEJ_2pNjE1I/AAAAAAAAFmM/2RsYnbH4ZNgrmzGSZ9rSHge-Ie1tmWw8ACEwYBhgL/s1600/DD_02%2B%25281%2529.jpg',
          },
          {
            id: 7,
            name: 'Gel Manicure',
            ...
            description:
               'nail lacquer invites you to flaunt a most sophisticated holiday manicure',
            image:
               'https://i.pinimg.com/originals/23/a1/ac/23a1ac8a5acf935e5c8c55b269a6a1ae.jpg',
          },
          {
            id: 8,
            name: 'Pedicure',
          ...
          },
          {
            ...
            image:
               'https://wedding-center.net/wp-content/uploads/2019/02/makeup3.jpg',
          },
          {
            id: 14,
            name: 'Simple',
            ...
            description:
               'help you find the perfect look to encompass your unique personality',
            image:
               'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR4uFGUYkWvsOJwWR0Z-enI4AQZLIXthYalWAgLgFzK17Fq-Ff4Cs4ORO8SnRtnoNOea6I&usqp=CAU',
          },
          {
            id: 15,
            name: 'Smokey',
            ...
            description:
               'help you find the perfect look to encompass your unique personality',
            image:
               'http://www.stylesweekly.com/wp-content/uploads/2018/01/15-hottest-smokey-eye-makeup-ideas-you-want-to-copy-now-4.jpg',
          },
          {
            id: 16,
            name: 'gliter',
            ...
            description:
               'help you find the perfect look to encompass your unique personality',
            image:
               'https://i.pinimg.com/originals/a4/20/89/a4208987338d1d524ab482219b9df9d3.jpg',
          }],
    };
